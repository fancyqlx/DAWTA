...
$(DIR_SRC)/enter_aggregator: $(DIR_SRC)/dawta.o $(DIR_SRC)/MyRSA.o $(DIR_SRC)/enter_aggregator.o
	g++ $(DIR_SRC)/dawta.o $(DIR_SRC)/MyRSA.o $(DIR_SRC)/enter_aggregator.o $(CFLAGS) -o $(DIR_SRC)/enter_aggregator
