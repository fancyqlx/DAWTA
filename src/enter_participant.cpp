...
class EchoClient{
    public:
        ...
        void handleConnection(std::shared_ptr<socketx::Connection> conn){
            ...
            ofstream fout("./data/enter_participants_logs",ofstream::out | ofstream::app);
        ...
        void handleReadEvents(std::shared_ptr<socketx::Connection> conn){
            if(stage==1){
                ...
                fout.open("./data/enter_participants_logs",ofstream::out | ofstream::app);
...
int main(int argc, char **argv){
    ...
    ofstream fout("./data/enter_participants_logs",ofstream::out);
